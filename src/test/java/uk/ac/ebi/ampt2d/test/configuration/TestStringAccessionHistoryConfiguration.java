...
public class TestStringAccessionHistoryConfiguration {

    @Autowired
    private TestAccessionHistoryStringRepository stringAccessionRepository;

    @Bean
    public BasicAccessionHistoryTrackingService<TestAccessionHistoryStringEntity, String>
    getAccessionHistoryTrackingService() {
        return new BasicAccessionHistoryTrackingService<>(stringAccessionRepository,
                TestAccessionHistoryStringEntity::new);
    }
