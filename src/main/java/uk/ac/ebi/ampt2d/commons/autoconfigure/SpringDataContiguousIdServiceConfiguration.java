 ...
 *
 */
package uk.ac.ebi.ampt2d.commons.autoconfigure;
 ...
 */
@Configuration
@EntityScan("uk.ac.ebi.ampt2d.commons.generators.monotonic.persistence.entities")
@EnableJpaRepositories(basePackages = "uk.ac.ebi.ampt2d.commons.generators.monotonic.persistence.repositories")
@ComponentScan(basePackages = "uk.ac.ebi.ampt2d.commons.generators.monotonic.persistence.service")
