 ...
 * @param <ACCESSION>
 */
public class ModelWrapper<MODEL, HASH, ACCESSION> {
    ...
    public ModelWrapper(ACCESSION accession, HASH hash, MODEL data) {
        this(accession, hash, data, 1);
    }

    public ModelWrapper(ACCESSION accession, HASH hash, MODEL data, int version) {
