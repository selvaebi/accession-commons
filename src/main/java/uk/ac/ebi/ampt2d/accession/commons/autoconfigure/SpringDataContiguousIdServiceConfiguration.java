 ...
 *
 */
package uk.ac.ebi.ampt2d.accession.commons.autoconfigure;
 ...
 */
@Configuration
@EntityScan("uk.ac.ebi.ampt2d.accession.commons.generators.monotonic.persistence.entities")
@EnableJpaRepositories(basePackages = "uk.ac.ebi.ampt2d.accession.commons.generators.monotonic.persistence.repositories")
@ComponentScan(basePackages = "uk.ac.ebi.ampt2d.accession.commons.generators.monotonic.persistence.service")
