...
@EnableJpaRepositories(basePackages = "uk.ac.ebi.ampt2d.accessioning.commons.generators.monotonic.persistence.repositories")
@ComponentScan(basePackages = "uk.ac.ebi.ampt2d.accessioning.commons.generators.monotonic.persistence.service")
